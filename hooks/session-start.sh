...
# Rules (compact — details in AGENTS.md and skills)
echo "CRITICAL: Use Trekker MCP tools (NOT task.md/TodoWrite). MANDATORY: Search (\`trekker search \"<keyword>\"\`) before any action."
echo ""
