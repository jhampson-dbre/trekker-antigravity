...
**IMPORTANT**: `/trekker-comment` is a skill (invoke via run_command / file edits), NOT a bash command. Use `trekker comment add` CLI as shown below.
...
2. Add the comment with agent name "agent"
